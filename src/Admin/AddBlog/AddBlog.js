...
export default function AddBlog() {
    ...
    // const formValid = () => {
    //     if (!title.length || !description.length || !guide.length || !file) {
    //         return <h1 className="text-xl text-red-500">Please fill all form inputs</h1>
    //     } else {
    //         return true
    //     }
    // }
    ...
    return (
        <div className="w-full max-w-2xl mx-auto p-8">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <h1 className="text-3xl my-6">Add Your New Food Recipe 🙌</h1>
                ...
                <button type="button"
                    ...
                    className="py-2 px-5 mb-3 bg-blue-600 rounded-2xl text-white hover:bg-blue-500">publish</button>
